        ...
        <div class="col-xl-9 col-lg-8 col-sm-12">
            <div class="card border-0">
                ...
                <div class="card-body pb-0">
                    <form method="POST" action="{{ route('admin.panel-notifications.update',$panelNotification->id) }}"
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control" required>
                                        @foreach(\App\Models\PanelNotification::TYPES as $type)
                                            <option class="text-{{$type}}"
                                                    @if($type==$panelNotification->type) selected
                            ...
                            <div class="col-sm-12 col-md-4">
                                @include('default.admin.partials.select', ['field' =>'status','options'=> \App\Models\PanelNotification::STATUSES,'edit'=>true,'dbValue'=>$panelNotification->status])
                            </div>

                            <div class="col-sm-12 col-md-4">
                                @include('default.admin.partials.select', ['field' =>'order','options'=> \App\Models\PanelNotification::ORDERS,'edit'=>true,'dbValue'=>$panelNotification->order])
                            </div>

                            <div class="col-sm-12 col-md-12">
                                @include('default.admin.partials.input', ['field' => 'title','edit'=>true,'dbValue'=>$panelNotification->title])
                            </div>


                            <div class="col-sm-12 col-md-12">
                                @include('default.admin.partials.textarea', ['field' => 'description','edit'=>true,'dbValue'=>$panelNotification->description])
                            </div>
